...
- (NSString *)urlEncoded {
    ...
    return (NSString *)CFBridgingRelease(CFURLCreateStringByAddingPercentEscapes(NULL,(__bridge CFStringRef)self,NULL,(CFStringRef)@"!*'\"();:@&=+$,/?%#[]% ",CFStringConvertNSStringEncodingToEncoding(kCFStringEncodingUTF8)));
    
}

#define GBKEncode CFStringConvertEncodingToNSStringEncoding(kCFStringEncodingGB_18030_2000)
